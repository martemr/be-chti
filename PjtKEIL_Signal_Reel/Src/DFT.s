...
DFT_ModuleAuCarre
	...
	; Partie Imaginaire
	ldr r2, =TabSin ; r4 est l'adresse du premier element du tableau de sin
	bl Calcul_DFT
	add r0, r4
...
Boucle
	...
	mul r7, r1, r3	    ; r7=p=k*n
	and r7, r7, #0x3F 	; r7 modulo 64 
	
	ldrsh r6, [r0, r3, lsl #1] 	; Lecture de x(n) : Signal
	ldrsh r8, [r2 , r7, lsl #1]	; Lecture de TabCos[r7] ou TabSin[r7]
	
	; Multiplier les deux valeurs
	mul r9, r6, r8  ; multiplier le signal x(n) et le cos ou sin
	adds r5, r9		; l'ajouter au résultat
